...
public class ESConfigurationHandler {
     ...
     */
    public static File createUserYMLStartupFile(int userID, URL host, int tcpport, int httpport, String mountedTCVolume)
     ...
     */
    public static void startElasticSearch(int userID) throws IOException, InterruptedException {
